...
import davi.nunes.ribeiro.galeria.MyViewHolder;
...
public class MainAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.list_item, parent, false); // cria os elementos de layout e guarda num objeto view
